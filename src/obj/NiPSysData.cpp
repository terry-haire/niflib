...
byte NiPSysData::GetHasVertexColors2() const {
	return hasVertexColors2;
}

void NiPSysData::SetHasVertexColors2( byte value ) {
	hasVertexColors2 = value;
}

vector<Color4 > NiPSysData::GetVertexColors() const {
	return vertexColors;
}

void NiPSysData::SetVertexColors( const vector<Color4 >& value ) {
	vertexColors = value;
}
