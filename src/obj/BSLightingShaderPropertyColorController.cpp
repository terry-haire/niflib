...
unsigned int BSLightingShaderPropertyColorController::GetTargetVariable() const {
	return targetVariable;
}

void BSLightingShaderPropertyColorController::SetTargetVariable( unsigned int value ) {
