...
vector<Vector4 > bhkCompressedMeshShapeData::GetVertices() const {
	return vertices;
}

void bhkCompressedMeshShapeData::SetVertices( const vector<Vector4 >& value ) {
	vertices = value;
}

array<4,bhkCMSD_Shape >  bhkCompressedMeshShapeData::GetShapeSet1() const {
	return shapeSet1;
}

void bhkCompressedMeshShapeData::SetShapeSet1( const array<4,bhkCMSD_Shape >&  value ) {
	shapeSet1 = value;
}

vector<bhkCMSDContainer > bhkCompressedMeshShapeData::GetShapeSet2() const {
	return shapeSet2;
}

void bhkCompressedMeshShapeData::SetShapeSet2( const vector<bhkCMSDContainer >& value ) {
	shapeSet2 = value;
}
