...
#ifndef _BSCLOTHEXTRADATA_H_
#define _BSCLOTHEXTRADATA_H_
...
typedef Ref<BSClothExtraData> BSClothExtraDataRef;

/*! Fallout 4 Cloth data */
class BSClothExtraData : public BSExtraData {
public:
	/*! Constructor */
	NIFLIB_API BSClothExtraData();

	/*! Destructor */
	NIFLIB_API virtual ~BSClothExtraData();
