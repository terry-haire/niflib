...
#ifndef _BHKPHYSICSSYSTEM_H_
#define _BHKPHYSICSSYSTEM_H_
...
typedef Ref<bhkPhysicsSystem> bhkPhysicsSystemRef;

/*! Fallout 4 Collision System */
class bhkPhysicsSystem : public BSExtraData {
public:
	/*! Constructor */
	NIFLIB_API bhkPhysicsSystem();

	/*! Destructor */
	NIFLIB_API virtual ~bhkPhysicsSystem();
