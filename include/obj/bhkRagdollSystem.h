...
#ifndef _BHKRAGDOLLSYSTEM_H_
#define _BHKRAGDOLLSYSTEM_H_
...
typedef Ref<bhkRagdollSystem> bhkRagdollSystemRef;

/*! Fallout 4 Ragdoll System */
class bhkRagdollSystem : public BSExtraData {
public:
	/*! Constructor */
	NIFLIB_API bhkRagdollSystem();

	/*! Destructor */
	NIFLIB_API virtual ~bhkRagdollSystem();
